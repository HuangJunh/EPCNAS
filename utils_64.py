...
class Utils(object):
    ...
    def generate_pytorch_file(cls, particle, curr_gen, id):
        ...
        drop_rates = [0.1, 0.1, 0.2, 0.2, 0.2]
        ...
        for i, dimen in enumerate(particle_a):
            ...
            if 0 <= dimen <= 63:
                ...
                if conv_name not in conv_name_list:
                    pool_sta = [1 if 128 <= particle_a[k] <= 191 else 0 for k in range(0, i)]
